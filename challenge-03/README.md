...
// Modifiquei o nome completo e deixei simplificado com nome e sobrenome.
...
if (pessoa.caminhouQuantosMetros === 1) {
  ...
  return 'Olá, eu sou ' + quem + ' ' + pessoa.nomeCompleto() + ', tenho ' + pessoa.idade + ' ' + vidade + ', ' + pessoa.mostrarAltura() + ', meu peso é ' + pessoa.peso + 'Kg e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + vmetro +'!';
}
